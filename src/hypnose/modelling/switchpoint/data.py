...
classification (via ``hypnose.io``), filters and concatenates the kept trials of every session
...
from hypnose.io.loaders import _load_trial_views, _odor_to_letter
