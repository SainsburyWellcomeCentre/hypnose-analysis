...
from src.analysis_freerun import RewardAnalyser, get_decision_accuracy, detect_stage, get_response_time
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        sys.argv.append("/Volumes/harris/hypnose/rawdata/sub-020_id-072/ses-57_date-20250612")
