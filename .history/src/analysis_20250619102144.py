    ...
    for e, end_idx in enumerate(end_initiation_indices):
        ...
        for i in range(end_idx - 1, -1, -1):  
            if events_df.loc[i, 'r1_olf_valve']:
                ...
                trial_id[e,0] = 2
                break
            elif events_df.loc[i, 'odourC_olf_valve'] or events_df.loc[i, 'odourD_olf_valve'] or events_df.loc[i, 'odourE_olf_valve'] or events_df.loc[i, 'odourF_olf_valve'] or events_df.loc[i, 'odourG_olf_valve']:
                closest_valve_idx = i
                trial_type = 'nonR'
