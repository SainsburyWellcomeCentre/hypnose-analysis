...
def plot_session_response_time(results_df, output_file=None, subject_id=None):
    ...
    trial_id = np.array(results_df['all_trial_id']).flatten()
    print(np.shape(trial_id))
    # Create the plot
    ...
    print(len(results_df['all_r1_correct_rt']))
    ax[0].scatter(r1_correct_trials, results_df['all_r1_correct_rt'], label='R1 correct RT', color='blue')
    ax[1].scatter(r2_correct_trials, results_df['all_r2_correct_rt'], label='R2 correct RT', color='red')

    ax[2].scatter(r1_incorrect_trials, results_df['all_r1_incorrect_rt'], label='R1 incorrect RT', color='blue')
    ax[3].scatter(r2_incorrect_trials, results_df['all_r2_incorrect_rt'], label='R2 incorrect RT', color='red')
