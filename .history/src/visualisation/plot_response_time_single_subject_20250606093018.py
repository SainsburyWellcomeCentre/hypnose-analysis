...
def plot_session_response_time(results_df, output_file=None, subject_id=None):
    ...
    ax.scatter(r1_incorrect_trials, results_df['all_r1_incorrect_rt'], label='R1 incorrect RT', color='blue', alpha=0.5)
    ax.scatter(r2_incorrect_trials, results_df['all_r2_incorrect_rt'], label='R2 incorrect RT', color='red', alpha=0.5)
