...
def plot_response_time(results_df, output_file=None, subject_id=None):
    ...
    r1_correct_rt = [results_df['total_r1_correct_rt'][outer][0] for outer, inner in r1_correct_trials]
    r2_correct_rt = [results_df['total_r2_correct_rt'][outer][0] for outer, inner in r2_correct_trials]
    r1_incorrect_rt = [results_df['total_r1_incorrect_rt'][outer][0] for outer, inner in r1_incorrect_trials]
    r2_incorrect_rt = [results_df['total_r2_incorrect_rt'][outer][0] for outer, inner in r2_incorrect_trials]
