...
def plot_session_response_time(results_df, output_file=None, subject_id=None):
    ...
    ax.hlines(y=results_df['all_r1_rt'], label='mean R1 RT', color='blue', linestyle='--', alpha=0.7)
    ax.hlines(y=results_df['all_r2_rt'], label='mean R2 RT', color='red', linestyle='--', alpha=0.7)
    ax.hlines(y=results_df['all_hit_rt'], label='mean hit RT', color='black', linestyle='--', alpha=0.7)
    ax.hlines(y=results_df['all_false_alarm_rt'], label='mean false alarm RT', color='gray', linestyle='--', alpha=0.7)
