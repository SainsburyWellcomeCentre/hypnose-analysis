...
from src.analysis import get_decision_accuracy, get_response_time, RewardAnalyser
...
def main(session_folder, across_sessions=True, stage=None, sessions=None, plot_file=None, subject_id=None):
    """
    ...
    if across_sessions:
        ...
        for (session_id, session_date), session_paths in sorted(grouped_sessions.items()):
            ...
            for session_path in session_paths:
                ...
                detected_stage = temp_instance._detect_stage()
                print(detected_stage)
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        sys.argv.append("/Volumes/harris/hypnose/rawdata/sub-025_id-076/ses-51_date-20250603")
    ...
    parser.add_argument("--sessions", default=None, help="List of session IDs (optional)") # 31 is 1st idx
