...
def plot_response_time(results_df, output_file=None, subject_id=None):
    ...
    print(len(trial_id))
    print(len(results_df['total_r1_correct_rt']))
    # Create the plot
    _, ax = plt.subplots(1, 1, sharex=True, figsize=(12,6))
    ...
    ax.scatter(r1_correct_trials, results_df['total_r1_correct_rt'], label='R1 correct RT', color='blue')
    ax.scatter(r2_correct_trials, results_df['total_r2_correct_rt'], label='R2 correct RT', color='red')
    ax.scatter(r1_incorrect_trials, results_df['total_r1_incorrect_rt'], label='R1 incorrect RT', color='cyan')
    ax.scatter(r2_incorrect_trials, results_df['total_r2_incorrect_rt'], label='R2 incorrect RT', color='orange')
                ...
                try:
                    ...
                    if response_time and response_time != {
                        ...
                        dir_info = {
                            ...
                            'rt': total_rt,
                            'r1_correct_rt': total_r1_correct_rt,
                            'r2_correct_rt': total_r2_correct_rt,
                            'r1_incorrect_rt': total_r1_incorrect_rt,
                            'r2_incorrect_rt': total_r2_incorrect_rt,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sessions", "-s", default=np.arange(31,53,1), help="List of session IDs (optional)")
