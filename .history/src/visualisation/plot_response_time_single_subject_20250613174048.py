            ...
            for session_path in session_paths:
                ...
                try:
                    ...
                    if detect_stage <= 7:
                        ...
                        response_time = src.analysis_freerun.get_response_time(session_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sessions", default=np.arange(55, 58), help="List of session IDs (optional)") 
