...
def plot_session_response_time(results_df, output_file=None, subject_id=None):
    ...
    ax[0].scatter(np.arange(0, len(results_df['all_r1_correct_rt'])), results_df['all_r1_correct_rt'], label='R1 correct RT', color='blue')
    ax[1].scatter(np.arange(0, len(results_df['all_r2_correct_rt'])), results_df['all_r2_correct_rt'], label='R2 correct RT', color='red')

    ax[2].scatter(np.arange(0, len(results_df['all_r1_incorrect_rt'])), results_df['all_r1_incorrect_rt'], label='R1 incorrect RT', color='blue')
    ax[3].scatter(np.arange(0, len(results_df['all_r2_incorrect_rt'])), results_df['all_r2_incorrect_rt'], label='R2 incorrect RT', color='red')
