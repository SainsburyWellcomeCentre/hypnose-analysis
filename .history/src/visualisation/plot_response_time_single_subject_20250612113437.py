...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        sys.argv.append("/Volumes/harris/hypnose/rawdata/sub-025_id-076/ses-32_date-20250506")
    ...
    parser.add_argument("--sessions", default=np.arange(32, 58), help="List of session IDs (optional)") 
