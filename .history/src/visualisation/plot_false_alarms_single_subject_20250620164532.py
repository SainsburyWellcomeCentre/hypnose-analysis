        ...
        for session_path in session_paths:
            ...
            try:
                ...
                if specificity and specificity != {'C_pokes': 0, 'C_trials': 0,
                    ...
                    total_C_false_alarm += specificity['C_false_alarm']
                    total_D_false_alarm += specificity['D_false_alarm']
                    total_E_false_alarm += specificity['E_false_alarm']
                    total_F_false_alarm += specificity['F_false_alarm']
                    total_G_false_alarm += specificity['G_false_alarm']
                    total_overall_false_alarm += specificity['overall_false_alarm']
