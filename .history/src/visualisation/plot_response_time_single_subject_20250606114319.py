...
def main(session_folder, across_sessions=False, output_file=None, plot_file=None, subject_id=None):
    ...
    if across_sessions:
        ...
        subject_path = os.path.split(os.path.split(pathname)[0])
...
if __name__ == "__main__":
    ...
    parser.add_argument("across_sessions", help="Whether to plot results for a single session or across sessions")
    ...
    main(args.session_folder, args.output, args.plot)
