...
def main(session_folder, across_sessions=True, sessions= None, plot_file=None, subject_id=None):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sessions", "-s", default=None, help="List of session IDs (optional)") # 31 is 1st idx
