...
def main(session_folder, across_sessions=True, output_file=None, plot_file=None, subject_id=None):
    ...
    if across_sessions:
        ...
        for (session_id, session_date), session_paths in sorted(grouped_sessions.items()):
            ...
            total_rt = 0
            total_r1_correct_rt = 0
            total_r2_correct_rt = 0
            total_r1_incorrect_rt = 0
            total_r2_incorrect_rt = 0
            ...
            for session_path in session_paths:
                ...
                try:
                    ...
                    if response_time and response_time != {
                        ...
                        # Add to totals
                        total_rt += response_time['rt']
                        total_r1_correct_rt += response_time['r1_correct_rt']
                        total_r2_correct_rt += response_time['r2_correct_rt']
                        total_r1_incorrect_rt += response_time['r1_incorrect_rt']
                        total_r2_incorrect_rt += response_time['r2_incorrect_rt']
                        total_r1_avg_correct_rt += response_time['r1_avg_correct_rt']
                        total_r2_avg_correct_rt += response_time['r2_avg_correct_rt']
                        total_r1_avg_incorrect_rt += response_time['r1_avg_incorrect_rt']
                        total_r2_avg_incorrect_rt += response_time['r2_avg_incorrect_rt']
                        total_r1_avg_rt += response_time['r1_avg_rt']
                        total_r2_avg_rt += response_time['r2_avg_rt']
                        total_hit_rt += response_time['hit_rt']
                        total_false_alarm_rt += response_time['false_alarm_rt']
                        total_trial_id += response_time['trial_id']
