...
def plot_response_time(results_df, output_file=None, subject_id=None):
    ...
    ax[0].scatter(r1_correct_trials, r1_correct_rt, s=1, label='R1 correct RT', color='blue')
    ax[1].scatter(r2_correct_trials, r2_correct_rt, s=1, label='R2 correct RT', color='red')
    ax[2].scatter(r1_incorrect_trials, r1_incorrect_rt, s=1, label='R1 incorrect RT', color='cyan')
    ax[3].scatter(r2_incorrect_trials, r2_incorrect_rt, s=1, label='R2 incorrect RT', color='orange')
