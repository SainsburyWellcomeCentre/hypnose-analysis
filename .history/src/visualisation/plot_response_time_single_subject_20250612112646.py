...
if __name__ == "__main__":
    ...
    parser.add_argument("--sessions", default=None, help="List of session IDs (optional)") 
    parser.add_argument("--start_session", default=31, help="Session after which to analyse")
