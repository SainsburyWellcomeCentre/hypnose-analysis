...
def plot_session_accuracy(results_df, output_file=None, subject_id=None):
    """
    Create a scatterplot of decision accuracy for each session.
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        sys.argv.append("/Volumes/harris/hypnose/rawdata/sub-026_id-077/ses-49_date-20250602")
