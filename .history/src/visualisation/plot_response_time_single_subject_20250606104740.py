...
def plot_session_response_time(results_df, output_file=None, subject_id=None):
    ...
    # ax.plot(results_df['all_r1_rt'], label='mean R1 RT', color='blue', linestyle='--', alpha=0.7)
    # ax.plot(results_df['all_r2_rt'], label='mean R2 RT', color='red', linestyle='--', alpha=0.7)
    # ax.plot(results_df['all_hit_rt'], label='mean hit RT', color='black', linestyle='--', alpha=0.7)
    # ax.plot(results_df['all_false_alarm_rt'], label='mean false alarm RT', color='gray', linestyle='--', alpha=0.7)
    
    # ax.hlines(y=results_df['all_r1_rt'], xmin=0, xmax=len(trial_id), label='mean R1 RT', color='blue', linestyle='--', alpha=0.7)
    # ax.hlines(y=results_df['all_r2_rt'], xmin=0, xmax=len(trial_id), label='mean R2 RT', color='red', linestyle='--', alpha=0.7)
    # ax.hlines(y=results_df['all_hit_rt'], xmin=0, xmax=len(trial_id), label='mean hit RT', color='black', linestyle='--', alpha=0.7)
    # ax.hlines(y=results_df['all_false_alarm_rt'], xmin=0, xmax=len(trial_id), label='mean false alarm RT', color='gray', linestyle='--', alpha=0.7)
...
def plot_across_sessions_response_time(results_df, output_file=None, subject_id=None):
    return 

def main(session_folder, across_sessions=False, output_file=None, plot_file=None, subject_id=None):
    """
    ...
    if across_sessions:
        plot_across_sessions_response_time(results)
    else:
        plot_session_response_time(results, output_file=output_file, subject_id=subject_id)
