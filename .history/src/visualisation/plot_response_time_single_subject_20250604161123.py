...
def plot_session_response_time(results_df, output_file=None, subject_id=None):
    ...
    ax[0].scatter(results_df['r2_correct_rt'], label='R2 correct RT', color='red')

    ax[1].scatter(results_df['r1_incorrect_rt'], label='R1 incorrect RT', color='blue')
    ax[1].scatter(results_df['r2_incorrect_rt'], label='R2 incorrect RT', color='red')
