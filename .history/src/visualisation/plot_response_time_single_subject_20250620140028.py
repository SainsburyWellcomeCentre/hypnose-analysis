...
def plot_session_response_time(results_df, plot_file=None, subject_id=None):
    ...
    ax[0].scatter(r1_correct_trials, results_df['all_r1_correct_rt'], s=5, label=labels[0], color='blue')
    ax[1].scatter(r2_correct_trials, results_df['all_r2_correct_rt'], s=5, label=labels[1], color='red')
    ax[2].scatter(r1_incorrect_trials, results_df['all_r1_incorrect_rt'], s=5, label=labels[2], color='green')
    ax[3].scatter(r2_incorrect_trials, results_df['all_r2_incorrect_rt'], s=5, label=labels[3], color='orange')
