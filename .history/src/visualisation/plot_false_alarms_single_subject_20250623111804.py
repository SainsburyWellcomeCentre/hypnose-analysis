...
def plot_false_alarms(results_df, output_file=None, subject_id=None):
    ...
    plt.scatter(results_df['date'], results_df['total_D_false_alarm'], 
               label='D False Alarm', marker='o', s=60, color='red')
