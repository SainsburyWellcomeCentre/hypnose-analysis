...
if __name__ == "__main__":
    ...
    parser.add_argument("subject_folder", default="/Volumes/harris/hypnose/rawdata/sub-026_id-077/ses-47_date-20250528", help="Path to the subject's folder containing session data")
